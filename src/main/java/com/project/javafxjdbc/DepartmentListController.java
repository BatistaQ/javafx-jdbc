...
import com.project.javafxjdbc.db.DbIntegrityException;
...
import static com.project.javafxjdbc.gui.util.Alerts.showConfirmation;
...
public class DepartmentListController implements Initializable, DataChangeListener {
    ...
    public void onBtNewAction(ActionEvent event){
        ...
        createDialogForm(obj,"/com/project/javafxjdbc/DepartmentForm.fxml", parentStage);
    }
            ...
            protected void updateItem(Department obj, boolean empty) {
                ...
                button.setOnAction(
                        event -> createDialogForm(
                                obj, "/com/project/javafxjdbc/DepartmentForm.fxml",Utils.currentStage(event)));
            }
        });
    }
